                ...
                <section className="bg-light py-4 py-md-5 py-xl-8 border-top border-light">
                    <div className="container overflow-hidden">
                        <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                            <div className="col-12 col-md-4 col-lg-3 col-xl-2 img-footer-container">
                                <div className='img-footer-container widget'>
                                    <a href="#!">
                                        <img src="images/Pict-w02bw.jpg" />
                                    </a>
                                </div>
                            </div>
                            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                                <div className="widget">
                                    <h4 className="widget-title mb-4">Contactenos</h4>
                                    <address className="mb-4">Cerrito 212 tercer piso, Ciudad Autonoma de Buenos Aires, Argentina</address>
                                    <p className="mb-1">
                                        <a className="link-secondary text-decoration-none" href="tel:+15057922430">(+54) 4792-2430</a>
                                    </p>
                                    <p className="mb-0">
                                        <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">info@shoppingworld.com</a>
                                    </p>
                                </div>
                            </div>
                            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                                <div className="widget">
                                    <h4 className="widget-title mb-4">Sepa más sobre...</h4>
                                    <ul className="list-unstyled">
                                        <li className="mb-2">
                                            <a href="#!" className="link-secondary text-decoration-none">Nosotros</a>
                                        </li>
                                        <li className="mb-2">
                                            <a href="#!" className="link-secondary text-decoration-none">Terminos y Condiciones</a>
                                        </li>
                                        <li className="mb-0">
                                            <a href="#!" className="link-secondary text-decoration-none">Política de Privacidad</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-12 col-lg-3 col-xl-4">
                                <div className="widget">
                                    <h4 className="widget-title mb-4">¡Sea Parte de Nuestra Comunidad!</h4>
                                    <p className="mb-4">Suscribete a nuestro boletin para recibir actualizaciones, ofertas y promociones.</p>
